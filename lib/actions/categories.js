...
export async function createCategory(formData) {
  // Defensa en profundidad: el proxy bloquea el acceso a la página de admin,
  // pero una Server Action es su propio endpoint (no queda atada a la ruta
  // desde la que se invoca), así que hay que revalidar sesión acá también.
